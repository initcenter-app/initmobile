...
class AppDelegate: UIResponder, UIApplicationDelegate,CAAnimationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        navigationController.view.layer.mask!.bounds = CGRect(x: 0, y: 0, width: 123, height: 180)
        navigationController.view.layer.mask!.anchorPoint = CGPoint(x: 0.5, y: 0.5)
        navigationController.view.layer.mask!.position = CGPoint(x: navigationController.view.frame.width / 2, y: navigationController.view.frame.height / 2)
        
        // logo mask background view
        let maskBgView = UIView(frame: navigationController.view.frame)
        //maskBgView.backgroundColor = UIColor.init(patternImage: UIImage(named: "logo")!)//UIColor(red: 241/255, green: 196/255, blue: 15/255, alpha: 1)
        ...
        let secondBounds = NSValue(cgRect: CGRect(x: 0, y: 0, width: 164, height: 240))
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "INIT_Center")
